                ...
                <nav class="p-4 space-y-1">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="pl-6 space-y-1 mt-1">
                            <a href="#" class="flex items-center space-x-3 px-4 py-2 bg-emerald-50 text-[#10B981] font-semibold rounded-md">
                                <span class="w-2 h-2 rounded-full bg-[#10B981]"></span>
                                <span>Supplier List</span>
                            </a>
                            <a href="#" class="flex items-center space-x-3 px-4 py-2 text-gray-500 hover:text-gray-800 rounded-md text-sm">
